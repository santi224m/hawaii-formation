            ...
            <div className="flex justify-center max-w-[18rem] m-auto mb-8 lg:mb-16">
              <div className="relative flex w-full mx-6 p-1 bg-gray-200 rounded-full">
                <span className="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
                  <span className={`absolute inset-0 w-1/2 bg-white rounded-full shadow-sm transform transition duration-150 ease-in-out ${annual ? 'translate-x-0' : 'translate-x-full'}`} />
                </span>
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-2 lg:gap-6 items-start lg:max-w-3xl pt-4">
              ...
              <div className="relative flex flex-col h-full p-6" data-aos="fade-right">
                <div className="mb-6">
                  ...
                  <Link className="btn text-white bg-blue-500 hover:bg-blue-600 w-full shadow-xs" href="/signup">Join The Community</Link>
                </div>
              ...
              <div className="relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-left">
                ...
                <div className="mb-6">
                  ...
                  <Link className="btn text-white bg-blue-500 hover:bg-blue-600 w-full shadow-xs" href="/signup">Start Free Trial</Link>
                </div>
